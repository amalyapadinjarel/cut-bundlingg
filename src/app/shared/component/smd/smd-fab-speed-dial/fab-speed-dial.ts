...
export class SmdFabSpeedDialTrigger {
     ...
     */
    @HostBinding('class.smd-')
    @Input() spin: boolean = false;

    constructor(@Inject(forwardRef(() => SmdFabSpeedDialComponent)) private _parent: SmdFabSpeedDialComponent | any) {
    }
...
export class SmdFabSpeedDialActions implements AfterContentInit {
    ...
    constructor(@Inject(forwardRef(() => SmdFabSpeedDialComponent)) private _parent: SmdFabSpeedDialComponent | any, private renderer: Renderer2) {
    }
